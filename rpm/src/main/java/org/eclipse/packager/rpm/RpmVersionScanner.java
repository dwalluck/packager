...
public final class RpmVersionScanner implements Iterator<CharSequence> {
    ...
    public RpmVersionScanner(CharSequence input) {
    ...
    private void skipNext(BitSet bitSet) {
    ...
    private int start(BitSet bitSet) {
        if (bitSet != DIGIT) {
            return position;
        }
